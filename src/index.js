...
const createContainerModalIntegrationTabBody = 'section[id^="pf-tab-section-"][id$="-create-image-dialog-tab-integration"].pf-v5-c-tab-content > div.pf-v5-c-form__field-group-body > div[id^="run-image-dialog-publish-"]' 
